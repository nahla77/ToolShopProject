...
//    public LanguageTest verifySortTextChanges(By languageOption) {
//        String before = getSortText();
//        clickLanguageDropdown();
//        selectLanguage(languageOption);
//
//        WebDriverWait wait = new WebDriverWait(driver.get(), Duration.ofSeconds(10));
//        wait.until(ExpectedConditions.not(
//                ExpectedConditions.textToBePresentInElementLocated(SortText, before))
//        );
//
//        String after = getSortText();
//        Assert.assertNotEquals(before, after, "❌ 'Sort' label did not change after language switch");
//        return this;
//    }
